...
| `maintain_pve.yaml` | Proxmox | Idempotent PVE node config: keepalived VIP, ansible user, SSH hardening; checks for VM snapshots older than 14 days (Discord warning alert); safe to re-run after node reinstall; Discord + MariaDB logging |
